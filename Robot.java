...
public class Robot extends TimedRobot {
    ...
    */
    ...
    /**
    * This function is called periodically during operator control. If a certain key is pressed on
    * the joystick,
    */
    @Override
    public void teleopPeriodic() {
        mSolenoidOne = new DoubleSolenoid(1, 2);
        mSolenoidOne = new DoubleSolenoid(1, 1, 2);
